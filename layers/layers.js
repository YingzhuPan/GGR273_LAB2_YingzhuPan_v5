...
//ol.proj.get("EPSG:3403").setExtent([-2331925.276063, 5328599.038235, 2558424.082259, 7115271.229543]);
var wms_layers = [];
...
var format_FishStockingLocation_2 = new ol.format.GeoJSON();
var features_FishStockingLocation_2 = format_FishStockingLocation_2.readFeatures(json_FishStockingLocation_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3403'});
var jsonSource_FishStockingLocation_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_FishStockingLocation_2.addFeatures(features_FishStockingLocation_2);
var lyr_FishStockingLocation_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_FishStockingLocation_2, 
                style: style_FishStockingLocation_2,
                popuplayertitle: "Fish Stocking Location",
                interactive: true,
    title: 'Fish Stocking Location<br />\
    <img src="styles/legend/FishStockingLocation_2_0.png" /> 0 - 1807<br />\
    <img src="styles/legend/FishStockingLocation_2_1.png" /> 1807 - 5600<br />\
    <img src="styles/legend/FishStockingLocation_2_2.png" /> 5600 - 11500<br />\
    <img src="styles/legend/FishStockingLocation_2_3.png" /> 11500 - 20000<br />\
    <img src="styles/legend/FishStockingLocation_2_4.png" /> 20000 - 40000<br />\
    <img src="styles/legend/FishStockingLocation_2_5.png" /> 40000 - 110000<br />\
    <img src="styles/legend/FishStockingLocation_2_6.png" /> 110000 - 1613075<br />'
        });

lyr_AlbertaBoundary_0.setVisible(true);lyr_Albertawaterbody_1.setVisible(true);lyr_FishStockingLocation_2.setVisible(true);
var layersList = [lyr_AlbertaBoundary_0,lyr_Albertawaterbody_1,lyr_FishStockingLocation_2];
...
lyr_FishStockingLocation_2.set('fieldAliases', {'DISTRICT': 'DISTRICT', 'WATERBODY': 'WATERBODY', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'SPECIES': 'SPECIES', 'GENOTYPE': 'GENOTYPE', 'STOCKED -': 'STOCKED -', 'STOCKING N': 'STOCKING N', 'PLANNED ST': 'PLANNED ST', 'Map Author': 'Map Author', 'NumStock': 'NumStock', });
...
lyr_FishStockingLocation_2.set('fieldImages', {'DISTRICT': 'TextEdit', 'WATERBODY': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'SPECIES': 'TextEdit', 'GENOTYPE': 'TextEdit', 'STOCKED -': 'TextEdit', 'STOCKING N': 'TextEdit', 'PLANNED ST': 'TextEdit', 'Map Author': 'TextEdit', 'NumStock': 'Range', });
